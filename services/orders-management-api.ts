...
export const OrdersManagementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrders: async (page?: number, pageSize?: number, orderId?: string, userId?: string, productId?: string, trackingCode?: string, paymentMethod?: GetOrdersPaymentMethodEnum, paymentStatus?: GetOrdersPaymentStatusEnum, orderStatus?: GetOrdersOrderStatusEnum, xLang?: GetOrdersXLangEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const OrdersManagementApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getOrders(page?: number, pageSize?: number, orderId?: string, userId?: string, productId?: string, trackingCode?: string, paymentMethod?: GetOrdersPaymentMethodEnum, paymentStatus?: GetOrdersPaymentStatusEnum, orderStatus?: GetOrdersOrderStatusEnum, xLang?: GetOrdersXLangEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListOrderResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getOrders(page, pageSize, orderId, userId, productId, trackingCode, paymentMethod, paymentStatus, orderStatus, xLang, options);
            const index = configuration?.serverIndex ?? 0;
...
export const OrdersManagementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getOrders(requestParameters: OrdersManagementApiGetOrdersRequest = {}, options?: AxiosRequestConfig): AxiosPromise<ListOrderResponseDTO> {
            return localVarFp.getOrders(requestParameters.page, requestParameters.pageSize, requestParameters.orderId, requestParameters.userId, requestParameters.productId, requestParameters.trackingCode, requestParameters.paymentMethod, requestParameters.paymentStatus, requestParameters.orderStatus, requestParameters.xLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update order status
...
export class OrdersManagementApi extends BaseAPI {
    ...
    public getOrders(requestParameters: OrdersManagementApiGetOrdersRequest = {}, options?: AxiosRequestConfig) {
        return OrdersManagementApiFp(this.configuration).getOrders(requestParameters.page, requestParameters.pageSize, requestParameters.orderId, requestParameters.userId, requestParameters.productId, requestParameters.trackingCode, requestParameters.paymentMethod, requestParameters.paymentStatus, requestParameters.orderStatus, requestParameters.xLang, options).then((request) => request(this.axios, this.basePath));
    }
