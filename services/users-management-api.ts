...
// @ts-ignore
import { ChangeRoleRequestDTO } from '../models';
// @ts-ignore
...
export const UsersManagementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} id 
         * @param {ChangeRoleRequestDTO} changeRoleRequestDTO 
         * @param {ChangeRoleUserXLangEnum} [xLang] The language of the response
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        changeRoleUser: async (id: string, changeRoleRequestDTO: ChangeRoleRequestDTO, xLang?: ChangeRoleUserXLangEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('changeRoleUser', 'id', id)
            // verify required parameter 'changeRoleRequestDTO' is not null or undefined
            assertParamExists('changeRoleUser', 'changeRoleRequestDTO', changeRoleRequestDTO)
            const localVarPath = `/users/{id}/change-role`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(changeRoleRequestDTO, localVarRequestOptions, configuration)
...
export const UsersManagementApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async changeRoleUser(id: string, changeRoleRequestDTO: ChangeRoleRequestDTO, xLang?: ChangeRoleUserXLangEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserMntResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.changeRoleUser(id, changeRoleRequestDTO, xLang, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['UsersManagementApi.changeRoleUser']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Create new user
...
export const UsersManagementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Change role user
         * @summary Change role user
         * @param {UsersManagementApiChangeRoleUserRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        changeRoleUser(requestParameters: UsersManagementApiChangeRoleUserRequest, options?: AxiosRequestConfig): AxiosPromise<UserMntResponseDTO> {
            return localVarFp.changeRoleUser(requestParameters.id, requestParameters.changeRoleRequestDTO, requestParameters.xLang, options).then((request) => request(axios, basePath));
        },
        /**
         * Create new user
         * @summary Create new user
...
/**
 * Request parameters for changeRoleUser operation in UsersManagementApi.
 * @export
 * @interface UsersManagementApiChangeRoleUserRequest
 */
export interface UsersManagementApiChangeRoleUserRequest {
    /**
     * 
     * @type {string}
     * @memberof UsersManagementApiChangeRoleUser
     */
    readonly id: string

    /**
     * 
     * @type {ChangeRoleRequestDTO}
     * @memberof UsersManagementApiChangeRoleUser
     */
    readonly changeRoleRequestDTO: ChangeRoleRequestDTO
     ...
     * @memberof UsersManagementApiChangeRoleUser
     */
    readonly xLang?: ChangeRoleUserXLangEnum
}
...
export interface UsersManagementApiGetUsersRequest {
     ...
     * @type {'SuperAdmin' | 'Admin' | 'Mod' | 'User' | 'all_role'}
     * @memberof UsersManagementApiGetUsers
     */
...
export class UsersManagementApi extends BaseAPI {
     ...
     * @memberof UsersManagementApi
     */
    public changeRoleUser(requestParameters: UsersManagementApiChangeRoleUserRequest, options?: AxiosRequestConfig) {
        return UsersManagementApiFp(this.configuration).changeRoleUser(requestParameters.id, requestParameters.changeRoleRequestDTO, requestParameters.xLang, options).then((request) => request(this.axios, this.basePath));
    }
...
/**
  ...
  * @enum {string}
  */
export enum ChangeRoleUserXLangEnum {
    En = 'en',
    ViVn = 'vi_VN'
}
/**
