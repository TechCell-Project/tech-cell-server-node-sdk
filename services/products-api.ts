...
export const ProductsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deleteProductVariation: async (productId: string, sku: string, xLang?: DeleteProductVariationXLangEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/products/{productId}/{sku}`
                .replace(`{${"productId"}}`, encodeURIComponent(String(productId)))
         ...
         * @throws {RequiredError}
         */
        getProductById: async (productId: string, detail?: boolean, xLang?: GetProductByIdXLangEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'productId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getProducts: async (page?: number, pageSize?: number, detail?: boolean, selectType?: GetProductsSelectTypeEnum, keyword?: string, xLang?: GetProductsXLangEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/products`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ProductsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getProductById(productId: string, detail?: boolean, xLang?: GetProductByIdXLangEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProductById(productId, detail, xLang, options);
            const index = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getProducts(page?: number, pageSize?: number, detail?: boolean, selectType?: GetProductsSelectTypeEnum, keyword?: string, xLang?: GetProductsXLangEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListProductResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProducts(page, pageSize, detail, selectType, keyword, xLang, options);
            const index = configuration?.serverIndex ?? 0;
...
export const ProductsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getProductById(requestParameters: ProductsApiGetProductByIdRequest, options?: AxiosRequestConfig): AxiosPromise<ProductDTO> {
            return localVarFp.getProductById(requestParameters.productId, requestParameters.detail, requestParameters.xLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get products list
        ...
        getProducts(requestParameters: ProductsApiGetProductsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<ListProductResponseDTO> {
            return localVarFp.getProducts(requestParameters.page, requestParameters.pageSize, requestParameters.detail, requestParameters.selectType, requestParameters.keyword, requestParameters.xLang, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update product by id
...
export class ProductsApi extends BaseAPI {
    ...
    public getProductById(requestParameters: ProductsApiGetProductByIdRequest, options?: AxiosRequestConfig) {
        return ProductsApiFp(this.configuration).getProductById(requestParameters.productId, requestParameters.detail, requestParameters.xLang, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getProducts(requestParameters: ProductsApiGetProductsRequest = {}, options?: AxiosRequestConfig) {
        return ProductsApiFp(this.configuration).getProducts(requestParameters.page, requestParameters.pageSize, requestParameters.detail, requestParameters.selectType, requestParameters.keyword, requestParameters.xLang, options).then((request) => request(this.axios, this.basePath));
    }
